...
if path == 'c:\\Users\\'+username+'\\masters-thesis': 
    slash = '\\'
else: 
    slash = '/'
...
path_for_results_folder = path+slash+'results'+slash
print("path_for_results_folder", path_for_results_folder)
print("path", path)
# Filter out only the directories that match your naming convention
#results_folders = [item for item in items if os.path.isdir(os.path.join(path_for_results_folder, item))]# and item.startswith('results-')]
#folder_name = results_folders[2]  #Velg hvilken i results du vil teste 
#print('tester folder', folder_name)
folder_name = 'results-2024-05-11_17-23-13'
print("tester", folder_name)
...
general_file_path = os.path.abspath('')+slash+'results'+slash+folder_name  # Replace with the actual path to your first file
file_names = [slash+'initial.txt', slash+'candidate_after_initial_local_search.txt', 
              slash+'candidate_after_initial_local_search_after_change_empl.txt',  
              slash+'candidate_after_initial_local_search_after_swap_empl.txt', 
              slash+'candidate_after_initial_local_search_after_ma.txt',
              slash+'candidate_after_initial_local_search_after_sa.txt']
...
for cand in range(1, iterations+1): 
    ...
    for file_name in file_name_list: 
        ...
        file_path_candidate = os.path.abspath('')+slash+'results'+slash+folder_name+slash+file_name+'.txt'  
...
# -------------------------- TEST FOR FINAL  ------------------
file_path = general_file_path+slash+'final.txt' 
status1 = compare_dictionary_with_candidate(file_path)
if status1 == False:
    print('SOmething wrong in', file_path)
    print('---------------------------')
