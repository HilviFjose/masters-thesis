...
class MainConfig:
    def __init__(self):
        ...
        self.num_of_constructions = 20 #20  #OBS: Bør ikke settes til over 5, for er usikkert hvro mye prosessoren tåler

        # Iterations in ALNS
        self.iterations = 100 #100

        #Number of paralell processes 
        self.num_of_paralell_iterations = 10 #10
        ...
        self.construction_insertor = 1 #1
        self.repair_insertor = 1 #1
        self.illegal_repair_insertor = 2 #2

        self.max_num_regret1 = 120 #120
        self.max_num_regret2 = 140 #140

        #Insertor som kan brukes en andel av gangene 
        self.fraction_repair_insertor = 1 #1
        ...
        self.weight_score_best_default = 35 #35
        self.weight_score_better_default = 15 #15
        self.weight_score_accepted_default = 5 #5
        ...
        self.weight_S = 1/4 #1/4       # Min skill difference
