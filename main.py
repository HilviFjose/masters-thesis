...
def main():
    ...
    constructor.route_plan.updateObjective(current_iteration=None, total_iterations=None)
    ...
    if constructor.route_plan.objective[0] != constructor.route_plan.getOriginalObjective():
        print(f"Penalty in first objective: {constructor.route_plan.getOriginalObjective() - constructor.route_plan.objective[0]}. Original Objective: {constructor.route_plan.getOriginalObjective()}, Updated Objective: {constructor.route_plan.objective[0]} ")
    ...
    localsearch = LocalSearch(initial_route_plan, current_iteration=None, total_iterations=None)
    initial_route_plan = localsearch.do_local_search()
    initial_route_plan.updateObjective(current_iteration=None, total_iterations=None)
